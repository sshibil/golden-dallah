...
const { motion, AnimatePresence } = window.FramerMotion || { 
  motion: { div: 'div', button: 'button', header: 'header', section: 'section', footer: 'footer', a: 'a', span: 'span', h1: 'h1', h2: 'h2', h3: 'h3', p: 'p' },
...
const Icon = ({ name, className = "w-5 h-5", ...props }) => {
  const icons = {
    Coffee: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 5.636a9 9 0 010 12.728m0 0l-2.829-2.829m2.829 2.829L21 21M15.536 8.464a5 5 0 010 7.072m0 0l-2.829-2.829m-4.243 2.829a9 9 0 010-12.728M5.636 5.636l2.829 2.829M3 21l2.829-2.829M12 3v3m0 12v3" />
      </svg>
    ),
    Utensils: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
    ...
    GraduationCap: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147L12 14.633l7.74-4.486M12 3L2 8.571l10 5.571 10-5.571L12 3zm0 12.429l7.74-4.486V16.5M4.26 12v4.5" />
      </svg>
    ),
    Users: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
    ...
    Crown: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3l3.5 6 5.5-3-2 10.5h-14L3 6l5.5 3L12 3z" />
      </svg>
    ),
    Phone: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
    ...
    MessageCircle: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641l-.608 2.37a.5.5 0 00.61.61l2.585-.646a2.62 2.62 0 011.58.118A8.93 8.93 0 0012 20.25z" />
      </svg>
    ),
    Instagram: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" {...p}>
    ...
    ChevronRight: (p) => (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" {...p}>
  ...
  <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="goldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="100%" stopColor="#997011" />
      </linearGradient>
    ...
    <path d="M 25 85 C 40 92, 60 92, 75 85 L 72 78 C 58 83, 42 83, 28 78 Z" fill="url(#goldGrad)" />
    <path d="M 32 78 C 30 55, 38 45, 43 38 C 41 33, 41 28, 44 24 L 56 24 C 59 28, 59 33, 57 38 C 62 45, 70 55, 68 78 Z" fill="url(#goldGrad)" stroke="#5E4304" strokeWidth="1.5" />
    <path d="M 33 60 C 45 65, 55 65, 67 60 C 66 63, 66 64, 65 67 C 55 71, 45 71, 35 67 Z" fill="url(#goldGlow)" />
    <path d="M 42 42 C 30 38, 18 28, 14 18 C 19 21, 28 28, 40 33 Z" fill="url(#goldGrad)" stroke="#7A590A" strokeWidth="1" />
    <path d="M 14 18 Q 12 12, 16 14 Z" fill="url(#goldGlow)" />
    <path d="M 58 35 C 78 35, 85 55, 67 72 L 64 68 C 78 54, 72 40, 57 40 Z" fill="url(#goldGrad)" />
    <path d="M 44 24 C 44 18, 47 14, 50 8 C 53 14, 56 18, 56 24 Z" fill="url(#goldGrad)" />
    <circle cx="50" cy="7" r="3" fill="url(#goldGlow)" />
  </svg>
);
...
// Main Application Component (White Theme)
function App() {
  ...
  // WhatsApp Message Formatting & Redirection
  const handleWhatsAppSubmit = (e) => {
    e.preventDefault();
    const eventLabel = t.booking.eventTypes.find(e => e.id === formData.eventType)?.label || formData.eventType;
  ...
  return (
    <div className={`min-h-screen bg-white text-[#1A1A1A] font-sans antialiased selection:bg-[#D4AF37] selection:text-white ${isRtl ? 'font-arabic' : 'font-english'}`}>
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#D4AF37]/30 shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            {/* Desktop Nav Links */}
            <nav className="hidden lg:flex items-center gap-8 text-sm font-semibold text-[#2D3748]">
              ...
              <a href="#capacity" className="hover:text-[#D4AF37] transition-colors">{t.nav.capacity}</a>
              <a href="#booking" className="hover:text-[#D4AF37] transition-colors">{t.nav.booking}</a>
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              >
                ...
                <span>{t.nav.vipCall}: +971 55 559 3389</span>
              </a>
              ...
              {formStep === 2 && (
                <motion.div initial={{ opacity: 0, x: 15 }} animate={{ opacity: 1, x: 0 }} className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[#0F2A23] mb-2">{t.booking.locationLabel}</label>
                      <select
              ...
              {formStep === 4 && (
                <motion.div initial={{ opacity: 0, x: 15 }} animate={{ opacity: 1, x: 0 }} className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-3.5 sm:space-y-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[#0F2A23] mb-1">{t.booking.phoneLabel}</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[#0F2A23] mb-1">{t.booking.notesLabel}</label>
                      <textarea
                        rows="3"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-12 pb-10 sm:pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-4 space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2.5 sm:space-y-3">
              ...
              >
                <Icon name="Instagram" className="w-5 h-5 text-pink-400" />
                <span className="text-xs font-semibold text-[#FAF8F5]">{t.contact.instagram}</span>
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-3 space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2.5 text-xs text-[#FAF8F5]/80">
              ...
              <div className="flex items-start gap-2">
                <Icon name="MapPin" className="w-4 h-4 text-[#D4AF37] shrink-0 mt-0.5" />
